...
#include "GfxCmd_ToneMapPass.h"

GfxCmd_ToneMapPass::GfxCmd_ToneMapPass(const std::shared_ptr<Texture>& aTextureSource, const std::shared_ptr<Texture>& aTextureTarget)
{
	mySourceTexture = aTextureSource;
	myTargetTexture = aTextureTarget;
}

void GfxCmd_ToneMapPass::Execute()
{
